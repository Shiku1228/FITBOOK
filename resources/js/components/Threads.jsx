...
float lineFn(vec2 st, float width, float perc, float offset, vec2 mouse, float time, float amplitude, float distance, float verticalOffset) {
...
const Threads = ({ color = [1, 1, 1], amplitude = 1, distance = 0, verticalOffset = 0, enableMouseInteraction = false, ...rest }) => {
  ...
  const propsRef = useRef({ color, amplitude, distance, verticalOffset, enableMouseInteraction });
  propsRef.current = { color, amplitude, distance, verticalOffset, enableMouseInteraction };
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uVerticalOffset: { value: propsRef.current.verticalOffset },
    ...
    function update(t) {
      ...
      const { color, amplitude, distance, verticalOffset, enableMouseInteraction } = propsRef.current;
