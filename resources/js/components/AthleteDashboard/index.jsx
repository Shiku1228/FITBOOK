              ...
              <div className="dropdown-panel notif-dropdown" ref={notifRef} style={{ position: 'fixed', top: '70px', right: '100px', display: 'block' }}>
                ...
                <div className="dropdown-body">
                  <div className="notif-item">
                    ...
                    <div>
                      <div className="notif-text">Session with <strong>Coach Ramon</strong> confirmed for tomorrow</div>
                      <div className="notif-time">5 minutes ago</div>
                    </div>
                  </div>
                  <div className="notif-item">
                    <span className="notif-dot-icon" style={{ background: T.success }} />
                    <div>
                      <div className="notif-text">Payment successful: <strong>₱720</strong></div>
                  ...
                  <div className="notif-item">
                    ...
                    <div>
                      <div className="notif-text">New AI coach match: <strong>92% similarity</strong></div>
            ...
            {showSettings && (
              <div className="dropdown-panel settings-dropdown" ref={settingsRef} style={{ position: 'fixed', top: '70px', right: '60px', display: 'block' }}>
                <div className="dropdown-body">
                  ...
                  <div className="settings-item" onClick={() => navigate('/notifications')} style={{ cursor: 'pointer' }}>
                    <span>Notifications</span>
                  </div>
                  <div className="settings-item" onClick={() => navigate('/payments')} style={{ cursor: 'pointer' }}>
