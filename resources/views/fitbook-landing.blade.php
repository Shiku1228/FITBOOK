...
<body>
  ...
  <div id="search-section">
    ...
    <div class="sport-pills">
      <div class="pill active"><i data-lucide="circle-dot" class="pill-icon" style="width:18px;height:18px;"></i>
        Basketball</div>
      ...
      <div class="pill"><i data-lucide="activity" class="pill-icon" style="width:18px;height:18px;"></i> Gymnastics
      </div>
    </div>
  </div>
  ...
  <section id="how">
    <div class="section-header">
      ...
      <h2 class="display display-md" style="max-width: 500px; margin-top: 12px;">From search to<br><span
          style="color: var(--lime);">sweat in minutes</span></h2>
    </div>
    ...
    <div class="steps-grid">
      <div class="step-card">
        ...
        <p class="body-md muted">Find facilities or coaches by sport, city, and available time slot — filtered to what's
          actually open right now.</p>
      </div>
      <div class="step-card">
        ...
        <p class="body-md muted">Real-time availability via Firebase means no double-bookings. Reserve your slot in one
          tap — it's held for 10 minutes while you pay.</p>
      </div>
      <div class="step-card">
        ...
        <p class="body-md muted">Checkout with GCash, Maya, or card via PayMongo. No account required for guests.
          Instant confirmation sent to your phone.</p>
      </div>
      <div class="step-card">
        ...
        <p class="body-md muted">Your QR booking code is your entry pass. No printouts, no paperwork. Rate your
          experience after to help the community.</p>
      </div>
    </div>
  </section>
        ...
        <div class="facility-img">
          <div class="court-pattern">
            <svg viewBox="0 0 340 180" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
              ...
              <rect x="20" y="20" width="300" height="140" fill="none" stroke="#CAFF00" stroke-width="2"
                opacity="0.3" />
              ...
              <rect x="155" y="80" width="30" height="20" fill="none" stroke="#CAFF00" stroke-width="1"
                opacity="0.15" />
              <text x="170" y="98" text-anchor="middle" fill="#CAFF00" font-size="10" opacity="0.25"
                font-family="sans-serif"><i data-lucide="circle-dot" style="width:18px;height:18px;"></i></text>
            </svg>
          </div>
        ...
        <div class="facility-img">
          <div class="court-pattern">
            <svg viewBox="0 0 340 180" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
              ...
              <line x1="68" y1="30" x2="68" y2="150" stroke="#6FBFFF" stroke-width="0.8" opacity="0.2"
                stroke-dasharray="4,4" />
              <line x1="116" y1="30" x2="116" y2="150" stroke="#6FBFFF" stroke-width="0.8" opacity="0.2"
                stroke-dasharray="4,4" />
              <line x1="164" y1="30" x2="164" y2="150" stroke="#6FBFFF" stroke-width="0.8" opacity="0.2"
                stroke-dasharray="4,4" />
              <line x1="212" y1="30" x2="212" y2="150" stroke="#6FBFFF" stroke-width="0.8" opacity="0.2"
                stroke-dasharray="4,4" />
              <line x1="260" y1="30" x2="260" y2="150" stroke="#6FBFFF" stroke-width="0.8" opacity="0.2"
                stroke-dasharray="4,4" />
              <text x="170" y="100" text-anchor="middle" fill="#6FBFFF" font-size="28" opacity="0.3"
                font-family="sans-serif"><i data-lucide="waves" style="width:18px;height:18px;"></i></text>
            </svg>
          </div>
        ...
        <div class="facility-img">
          <div class="court-pattern">
            <svg viewBox="0 0 340 180" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
              ...
              <rect x="40" y="20" width="260" height="140" fill="none" stroke="#CAFF00" stroke-width="2"
                opacity="0.4" />
  ...
  <section id="coaches">
    <div class="section-header" style="display: flex; justify-content: space-between; align-items: flex-end;">
      <div>
        ...
        <h2 class="display display-md" style="margin-top: 12px;">Train with the <span
            style="color: var(--lime);">best</span></h2>
      </div>
    ...
    <div class="coaches-grid">
      ...
      <div class="coach-card">
        ...
        <div class="coach-bio">10-year PBA career. Specializes in ball handling, shooting mechanics, and youth
          development for ages 12–22.</div>
      ...
      <div class="coach-card">
        ...
        <div class="coach-bio">Former national swimmer. Expert in freestyle, butterfly, and competitive race strategy.
          Davao-based.</div>
        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
      ...
      <div class="coach-card">
        ...
        <div class="coach-bio">AFC B-licensed coach with 8 years of experience in youth academies and amateur clubs in
          Visayas.</div>
        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
      ...
      <div class="coach-card">
        ...
        <div class="coach-bio">ITF-ranked doubles specialist. Cebu-based, available for private sessions and group
          clinics on weekends.</div>
        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
          <span class="coach-tag">Intermediate</span>
  ...
  <section id="ai">
    <div class="ai-container">
      <div>
        ...
        <h2 class="display display-md" style="margin-top: 12px; margin-bottom: 32px;">The right coach,<br><span
            style="color: var(--lime);">found for you</span></h2>
        ...
        <div class="ai-feature">
          ...
          <div>
            ...
            <p class="body-md muted">Tell us your sport, skill level, and what you want to improve. Our AI reads coach
              bios and matches on substance, not just sport category.</p>
          </div>
        </div>
        ...
        <div class="ai-feature">
          ...
          <div>
            ...
            <p class="body-md muted">Matching weighs proximity so you're paired with coaches who are actually reachable
              — not just those with the best ratings nationally.</p>
          </div>
        </div>
        ...
        <div class="ai-feature">
          ...
          <div>
            ...
            <p class="body-md muted">Powered by Ollama running llama3.2 + nomic-embed-text — fast, private, and doesn't
              send your data to third-party servers.</p>
          </div>
        </div>
      </div>
      ...
      <div class="ai-graphic">
        ...
        <!-- outer nodes -->
        <div class="ai-node active" style="top:18%;left:50%;transform:translateX(-50%);"><i data-lucide="circle-dot"
            style="width:18px;height:18px;"></i></div>
        <div class="ai-node" style="top:35%;right:10%;"><i data-lucide="waves" style="width:18px;height:18px;"></i>
        </div>
        <div class="ai-node active" style="bottom:18%;left:50%;transform:translateX(-50%);"><i data-lucide="circle"
            style="width:18px;height:18px;"></i></div>
        <div class="ai-node" style="top:35%;left:10%;"><i data-lucide="target" style="width:18px;height:18px;"></i>
        </div>
        <div class="ai-node active" style="top:65%;right:10%;"><i data-lucide="flame"
            style="width:18px;height:18px;"></i></div>
        <div class="ai-node" style="top:65%;left:10%;"><i data-lucide="feather" style="width:18px;height:18px;"></i>
        </div>
        <!-- center -->
        <div class="ai-center">
  ...
  <section id="payments">
    <div class="pay-grid">
      <div>
        ...
        <h2 class="display display-md" style="margin-top: 12px; margin-bottom: 20px;">Pay the way<br><span
            style="color: var(--lime);">Filipinos pay</span></h2>
        <p class="body-lg muted" style="margin-bottom: 32px;">GCash, Maya, or card — checkout in under a minute. All
          transactions go through PayMongo, the Philippines' leading payment gateway.</p>
  ...
  <section id="cta">
    ...
    <div style="position: relative; z-index: 1;">
      ...
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        <a href="#" class="btn"
          style="background: var(--navy); color: var(--lime); padding: 16px 36px; font-size: 16px;">Find a court</a>
        <a href="#" class="btn"
          style="background: transparent; color: var(--navy); border: 2px solid var(--navy); padding: 16px 32px; font-size: 16px;">Match
          me a coach</a>
      </div>
    </div>
  </section>
  ...
  <footer>
    <div class="footer-top">
      <div class="footer-brand">
        <div class="logo">Fit<span>Book</span></div>
        <p>The sports booking platform built for the Philippines. Find courts, hire coaches, and pay with GCash — all in
          one place.</p>
      </div>
